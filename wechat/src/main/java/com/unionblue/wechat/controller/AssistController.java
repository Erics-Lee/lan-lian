...
public class AssistController {
     ...
     * @return
     */
	@RequestMapping("/uploadInvoiceImageFiles")
    @ResponseBody
	public String uploadInvoiceImageFiles(String base64Codes) {
		System.out.println(base64Codes);
	    String str = "[{\"ImageBinaryCodes\":\"daRU5ErkJggg==\"}]";
