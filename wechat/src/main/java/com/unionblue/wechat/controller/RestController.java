...
public class RestController {
    ...
    public String invoiceDetail(HttpServletRequest request, Model model, String tasksid, String invoiceid){
		model.addAttribute("tasksid", tasksid);
	...
	public String invoiceList(HttpServletRequest request){
		return "/invoiceList";
	}
	
	@RequestMapping("/invoiceDetail2")
	public String invoiceDetail2(HttpServletRequest request, Model model, String tasksid, String invoiceid){
		model.addAttribute("tasksid", tasksid);
		model.addAttribute("invoiceid", invoiceid);
