...
public class UserServiceImpl implements UserService{
    ...
    public String userDetail(String sessionKey) {
        ...
        String ReturnCode = (String) InvoiceStatisticsJson.get("ReturnCode");
        if (!ReturnCode.equals("0000")) {
            return JsonUtil.error(InvoiceStatisticsJson.get("ReturnMessage"));
        } else {
            ...
            map.put("rawcompanyname", companyInfo.getCompayname());
	...
	@Override
	public String societyQueryAccount(String societyIDToken) {
		Map<String, String> map = new HashMap<String, String>();
		map.put("SocietyID", "1");
		map.put("SocietyIDToken", societyIDToken);
