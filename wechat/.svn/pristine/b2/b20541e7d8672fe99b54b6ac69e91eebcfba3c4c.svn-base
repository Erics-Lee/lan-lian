...
public class CompanyInfo implements Serializable{
	...
	public void setCompayname(String compayname) {
		this.compayname = (StringUtil.isEmpty(compayname) || compayname.startsWith("等待")) ? "等待蓝联专家翻译":compayname;
	}
	...
	public void setEnglishaddress(String englishaddress) {
		this.englishaddress = (StringUtil.isEmpty(englishaddress) || englishaddress.startsWith("等待")) ? "等待蓝联专家翻译":englishaddress;
	}
	...
	public String toString() {
		return "CompanyInfo [companyno=" + companyno + ", rawcompanyname=" + rawcompanyname + ", rawaddress="
				...
				+ uniformnumber + ", imageBase64=" + imageBase64 + "]";
	}
